...
export default function Home() {
  ...
  const discordId = '659716108902989835';
  ...
  const audioTracks = [
    {
      ...
      name: 'sdp interlude',
      artist: 'Travis Scott',
      src: 'https://r2.guns.lol/f0b7ab6b-4765-47e8-999e-e5e0e2c65e41.mp3',
      cover: 'https://r2.guns.lol/b562a385-d8de-4c0a-858c-c2e3ccf8ebef.jpg',
    },
    {
      id: '2',
      name: 'Rather Lie',
      artist: 'Playboi Carti + The Weekend',
      src: 'https://r2.guns.lol/6ba00117-48f1-47f6-aced-f63cdeb60f4b.mp3',
    ...
    },
    {
      ...
      name: 'Dark Thoughts',
      artist: 'Lil Tecca',
      src: 'https://r2.guns.lol/d2e3004b-71e0-4982-a9d9-5dddea454159.mp3',
      cover: 'https://i.snipp.gg/924822581117337691/b99a5f3b62522d179008a1624a9f3785.png',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center relative overflow-hidden select-none">
      <video
        src="https://r2.guns.lol/776f87c6-9e2b-4b4d-a7df-274663cd0418.mp4"
        autoPlay
        loop
        muted
        playsInline
      ...
      >
        <div className="mb-6 w-full">
          <h1 className="text-4xl font-semibold text-white glowing-text text-center mb-2">Charlie</h1>
        ...
        <div className="flex space-x-6 mt-6 mb-5">
          {[
            {
              href: 'https://snapchat.com/add/charlieanddat',
              icon: (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {
              href: 'https://instagram.com/charlieanddat',
              icon: (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-8 h-8 text-white glowing-icon"
